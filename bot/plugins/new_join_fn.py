        ...
        try:
            ...
            await message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("Join Updates Channel", url=f"https://t.me/{BOTS_ASK}")
                        ]
                    ]
                ),
                parse_mode="markdown"
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('Developer', url='https://t.me/N_A_V_I_P_A_V_I'), # Bloody Thief, Don't Become a Developer by Stealing other's Codes & Hard Works!
                    InlineKeyboardButton('Source Code', url='https://github.com/Abir/VideoCompress') # Must Give us Credits!
                ]
            ]
        ),
        quote=True
